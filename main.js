...
(function () {
  ...
  const EXTRAS = [
    ...
    { id: "resources", num: "+", title: "Resources", href: "Resources.html", icon: "bi-journal-text", keywords: "resources books videos youtube channels courses links reading list learn more documentation" }
  ];
  ...
  /* ----------------------------------------------------------------------
     13. Resource preview images — graceful fallback
